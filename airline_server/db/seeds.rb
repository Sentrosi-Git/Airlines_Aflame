...
Flight.destroy_all
f1 = Flight.create :flight_number => 'BU666', :origin => 'SYD', :destination => 'PER', :departure_date => '01/09/2018 17:00'
f2 = Flight.create :flight_number => 'BU410', :origin => 'NYC', :destination => 'AUC', :departure_date => '02/07/2018 08:00'
f3 = Flight.create :flight_number => 'LJ100', :origin => 'SYD', :destination => 'BAL', :departure_date => '01/08/2018 14:00'
f4 = Flight.create :flight_number => 'BU111', :origin => 'PER', :destination => 'MEL', :departure_date => '01/11/2018 15:00'
f5 = Flight.create :flight_number => 'SW777', :origin => 'SYD', :destination => 'LDN', :departure_date => '15/05/2018 20:00'
